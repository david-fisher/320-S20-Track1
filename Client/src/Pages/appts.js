        ...
        return (
            <div className={classes.root}>
                ...
                <main className={classes.content}>
                    ...
                    >
                        <DialogTitle
                            className={classes.createAppointmentDialogTitle}
                        >
                            ...
                            !appointment.cancelled && (
                                <Grid item lg={12}>
                                    <AppointmentCard
                                        ...
                                        date={appointment.time_of_appt.substring(
                                            0,
                                            10
                                        )}
                                        supporter={
                                            appointment.supporterFN +
                                            ' ' +
                                            appointment.supporterLN
                                        }
                                        student={
                                            appointment.studentFN +
                                            ' ' +
                                            appointment.studentLN
                                        }
                                        supporterProfilePic={
                                            appointment.supporterPic
                                        }
                                        studentProfilePic={
                                            appointment.studentPic
                                        }
